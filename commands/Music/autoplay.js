	...
	run: async (client, message, args) => {
		try {
			...
			try {
				...
				// Toggle autoplay (stored on player as custom data)
				...
				message.reply({
					embeds: [new MessageEmbed()
					  .setColor(ee.color)
					  .setTimestamp()
					  .setTitle(`**${autoplay ? `${client.allEmojis.check_mark} Enabled` :`${client.allEmojis.x} Disabled`} Autoplay!**`)
					  .setDescription(autoplay ? "I will now play related songs automatically!" : "Autoplay disabled.")
