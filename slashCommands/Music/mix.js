...
module.exports = {
	name: "mix",
	description: "Plays a YouTube Mix",
	cooldown: 2,
	requiredroles: [],
	alloweduserids: [],
	options: [{ "String": { name: "song", description: "Which Song/Mix do you want to play", required: true } }],
	run: async (client, interaction) => {
		try {
			...
			try {
				...
				interaction.editReply({ content: `🎶 Added ${result.tracks.length} tracks: \`\`\`css\n${Text}\n\`\`\``, ephemeral: true });
			} catch (e) {
